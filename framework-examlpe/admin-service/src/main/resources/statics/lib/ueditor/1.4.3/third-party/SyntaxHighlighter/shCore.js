...
;(function()
{
    ...
    function Brush()
    {
        ...
        var specials   = 'activate add alias AppleScript ask attachment boolean class com.zhaofei.framework.common.constant delete duplicate empty exists false id integer list make message modal modified new no paragraph pi properties quit real record remove rest result reveal reverse run running save string true word yes';
